...
var UserModule = (function (_super) {
    ...
    UserModule.prototype.idExists = function (params, callback) {
        this.callWithConnection(this.__idExists, params, callback);
    };
    UserModule.prototype.__idExists = function (connection, params, callback) {
